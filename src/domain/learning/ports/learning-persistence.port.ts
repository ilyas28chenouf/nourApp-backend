...
export interface LearningPersistencePort {
  findItems(): Promise<LearningItemModel[]>;
  findItemById(id: string): Promise<LearningItemModel | null>;
  findProgressByUserId(userId: string): Promise<any[]>;
  findProgressById(id: string): Promise<any | null>;
